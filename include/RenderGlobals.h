#ifndef RENDERGLOBALS_H_  //this class will hold camera po, projectio, meshes
...
public:
	...
	~RenderGlobals() = delete;
	static void setView(const ngl::Vec3& _eye, const ngl::Vec3& _look, const ngl::Vec3& _up);  //set view matrix
